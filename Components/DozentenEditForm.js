...
function DozentenEditForm() {
    ...
    /* Hier werden die Daten des Dozentens von der API geladen. Der API-Call wird asynchron ausgeführt */
    const getData = async () => {
        /* Fehler abfangen */
        try{
            const res = await axios.get("https://luca.dnet.ch/dozenten/" + id_dozent);
    ...
    const updateData = async () => {
        ...
        try{
            const response = await axios.put("https://luca.dnet.ch/dozenten/" + id_dozent, json, config);
