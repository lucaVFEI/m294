...
function LaenderEditForm() {
    ...
    /* Hier werden die Daten des Laenders von der API geladen. Der API-Call wird asynchron ausgeführt */
    const getData = async () => {
        /* Fehler abfangen */
        try{
            const res = await axios.get("https://luca.dnet.ch/laender/" + id_land);
    ...
    const updateData = async () => {
        ...
        try{
            const response = await axios.put("https://luca.dnet.ch/laender/" + id_land, json, config);
    ...
    return (
        ...
        <Form.Group className="mb-3" controlId="fromLand">
...
export default LaenderEditForm;
